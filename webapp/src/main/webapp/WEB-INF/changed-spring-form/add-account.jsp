    ...
    <div class="col-sm-8 col-sm-offset-2">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form method="post" id="signupForm1" class="form-horizontal" action="">
          <form:form method="post" id="signupForm1" class="form-horizontal" modelAttribute="account">

            <div class="form-group">
              <form:label path="accountName" class="col-sm-4 control-label" for="username1">Username</form:label>
              <div class="col-sm-5">
                <form:input path="accountName" type="text" class="form-control" id="username1"
                        required="required"/>
              </div>
            </div>
            <div class="form-group">
              <form:label path="email" class="col-sm-4 control-label" for="email1">Email</form:label>
              <div class="col-sm-5">
                <form:input path="email" type="text" class="form-control" id="email1" required="required"/>
              </div>
            </div>
            <div class="form-group">
              <form:label path="password" class="col-sm-4 control-label" for="password1">Password</form:label>
              <div class="col-sm-5">
            ...
            <div class="form-group">
              <div class="col-sm-9 col-sm-offset-4">
                <button class="btn btn-primary" name="signup1" value="Sign up">Sign up
                </button>
              </div>
            </div>
          </form:form>
